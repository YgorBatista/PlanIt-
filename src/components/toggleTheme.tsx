...
export function ToogleTheme() {
    ...
    return (
        <div>
            <Button variant="outline" className="bg-[#cab69b] h-8 w-8 hover:bg-[#af9b80] dark:bg-[#1b2632] hover:dark:bg-[#32669c] relative" onClick={handleToggle} aria-label="Alternar tema">
